    ...
    const HandleAddClass = async (event) => {
        ...
        if (selectedImage) {
            ...
            try {
                ...
                fetch('https://12th-assignment-server-side.vercel.app/classes',
                    {
                        method: 'post',
    ...
    return (
        <Bounce duration={1200}> <div className='hero mt-10 '>
            <div className="card shadow-2xl bg-slate-800 p-5" style={{ width: '600px' }}>
                <h2 className='m-5 font-bold text-2xl text-center' >Add a Class</h2>
                <form onSubmit={HandleAddClass}>
                    <div className="form-control">
                        <span className='font-bold'>Class Name: </span>
                        <input name="cname" type="text" placeholder="" className="input input-bordered bg-slate-700" required />
                    </div><br></br>

                    <div className="form-control">
                        <span className='font-bold'>Price: </span>
                        <input name="price" type="number" placeholder="  (BDT)" className="input input-bordered bg-slate-700" required />
                    </div><br></br>

                    <div className="form-control">
                        <span className='font-bold'>Image: </span>
                        <input type="file" className="file-input file-input-bordered bg-slate-700" accept="image/*" onChange={handleImageSelect} />
                    </div><br></br>
                    ...
                    <div className="form-control">
                        ...
                        <input name="seats" type="number" placeholder="  " className="input input-bordered bg-slate-700" required />
                    </div><br></br>

                    <div className="form-control" style={{ display: "none" }}>
                        <span className='font-bold'>Enrolls: </span>
                        <input name="enrolls" type="number" placeholder="  " className="input input-bordered bg-slate-700" defaultValue='0' required readonly />
                    </div>

                    <div className="form-control mt-6">
                        <input className="btn btn-outline btn-primary" type="submit" value="Add a Class" />
                    </div>
                </form>
            </div>
        </div></Bounce >
